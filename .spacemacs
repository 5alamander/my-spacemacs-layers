...
values."
  ...
  (setq-default
   ...
   ;; Courier New, Source Code Pro, 微软雅黑, DejaVu Sans Mono, 雅黑Consolas混合(YaHei Consolas Hybrid)
   ...
   dotspacemacs-highlight-delimiters 'any ;'all
...
layers configuration. You are free to put any user code."
  ...
  ;; org-src-fontify-natively, show the code in org
  ...
  ;; Microsoft YaHei
  (spacemacs//set-monospaced-font "Source Code Pro" "Microsoft YaHei" 15 18)

  ;; my init
  (sa1/init)
  ;; (sa1/init-paredit) ;; this need not to load
  ;; close some thing
)
...
(custom-set-variables
 ...
 '(bmkp-last-as-first-bookmark-file "d:\\Emacs\\spacemacs\\.emacs.d\\.cache\\bookmarks")
 '(pyim-dicts
   (quote
    ((:name "BigDict-01" :file "d:/Emacs/spacemacs/.emacs.d/.cache/pyim-bigdict.pyim" :coding utf-8-unix :dict-type pinyin-dict)))))
